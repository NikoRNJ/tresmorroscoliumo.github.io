        ...
        <div className="grid gap-12 lg:grid-cols-[1.05fr_0.95fr] items-center">
          <div>
            ...
            <p className="text-lg text-gray-300 mb-4">
              Queremos que cada turista se sumerja en Coliumo más allá del descanso. Al conocer la historia detrás
              de Caleta del Medio, Vega del Coliumo y Los Morros, la experiencia se transforma en un viaje sensible
              que conecta con la comunidad, el mar y la naturaleza.
            </p>
            <p className="text-lg text-gray-300">
              Nuestro equipo diseña momentos para que desconectes de lo habitual: caminatas guiadas, conversaciones
              con artesanos y espacios creados para escuchar el viento. Así, cada propósito personal encuentra su
              cabaña ideal.
            </p>
            ...
            {cabinStories.map((story, index) => (
              ...
              >
                ...
                <div className="flex items-center justify-between mb-3">
                  <span className="text-sm uppercase tracking-[0.3em] text-primary-200">
