...
export const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant = 'primary', size = 'md', isLoading, children, disabled, ...props }, ref) => {
    ...
    const variants = {
      primary:
        'bg-primary-500 hover:bg-primary-600 text-dark-950 shadow-lg hover:shadow-xl hover:shadow-primary-500/30',
      secondary:
        'bg-transparent border-2 border-primary-500 hover:bg-primary-500 text-primary-500 hover:text-dark-950',
      outline:
